...
export default function TierOrganik({ point }: prop) {
  const { progress, remain, targetPoint } = getTierProgress(point, "organik");
  console.log({
    point,
    progress,
    remain,
    ...
    <div className="mx-auto flex max-w-5xl flex flex-col gap-12 px-6 py-10">
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <div className="w-full max-w-xl space-y-5 text-center">
          <h1 className="text-5xl font-bold text-[#283618]">Tier Organik</h1>
        ...
        <div className="space-y-5">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-3xl font-bold text-[#283618]">
              Keuntungan Tier Organik
            </h2>
          </div>

          {benefitOrganik.map((benefit, index) => (
            <Card
              key={index}
