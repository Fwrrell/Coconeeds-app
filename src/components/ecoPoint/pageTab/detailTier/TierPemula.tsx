...
const benefitPemula = [
  {
    title: "Gratis Penjemputan 1x",
    desc: "Layanan gratis biaya penjemputan hasil panen ataupun limbah yang ingin dikirimkan ke koperasi desa",
  },
  {
    title: "Gratis 5 bibit kelapa",
    desc: "Dapatkan 5 Bibit kelapa setiap bulan yang dapat ditukarkan di koperasi desa",
  },
  {
    title: "Bonus EcoPoint 0.25x",
...
export default function TierPemula({ point }: prop) {
  const { progress, remain, targetPoint } = getTierProgress(point, "pemula");
  return (
    <div className="mx-auto flex max-w-5xl flex flex-col gap-12 px-6 py-10">
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <div className="w-full max-w-xl space-y-5 text-center">
          <h1 className="text-5xl font-bold text-[#283618]">Tier Pemula</h1>
        ...
        <div className="space-y-5">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-3xl font-bold text-[#283618]">
              Keuntungan Tier Pemula
            </h2>
          </div>

          {benefitPemula.map((benefit, index) => (
            <Card
              key={index}
